  ...
  <!-- Set up your HTML -->
	...
	<div class="container mb-5">
    	...
    	<div class="alert alert-primary text-center"> 
            ...
            <img class="card-img-top" src="{{ asset('assets/images/confused.png') }}" alt="Card image cap" style="width: 10%; margin-bottom: 30px">
         

          	<h5 style="color: #0C2E8A">

	            Yaahh.. Anda sudah pernah mengikuti survey periode ini.
              <br>

              Mohon kembali di lain waktu!
