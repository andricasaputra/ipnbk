	...
	<div class="wrapper">
		...
		<div role="main" class="main" >
			 ...
			 <div style="text-align: center;">
			 	<img class="card-img-top" src="{{ asset('assets/images/woman.png') }}" alt="Card image cap" style="width: 10%; text-align: center;">
        	<br>
			 </div>

			<?php $messages = 'Mohon Maaf Untuk Saat Ini Tidak Ada Survey Yang Tersedia :('; ?>
